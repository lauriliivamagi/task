...
export const ACTION_LABELS: Record<ActionId, string> = {
  ...
  pasteImageAttachment: "Paste image as attachment",
...
export const ACTION_TO_EVENT: Record<ActionId, string | null> = {
  ...
  deleteAttachment: "START_DELETE_ATTACHMENT",
  pasteImageAttachment: "PASTE_IMAGE_ATTACHMENT",
...
const DEFAULT_DETAIL_BINDINGS: DefaultBinding[] = [
  ...
  { key: "O", action: "openAttachment" },
  { key: "X", action: "deleteAttachment" },
  { key: "V", action: "pasteImageAttachment" },
